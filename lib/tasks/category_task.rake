    ...
    categories.each do |category|
      ...
      Dir.foreach('categories/' + category) do |image|
        unless except_dir.include?(image)
          ...
          img = Image.new(title: image[0...-4], remote_image_url: 'https://github.com/tymosVS/gallery/blob/master/lib/assets/categories/romantizm/Arkhitektura-romantizma-2.jpg')
          img.save
